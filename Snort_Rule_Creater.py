...
#Murat BULBUL
#Senior Techology Consultant @Biztek Bilisim
import sys
import os
from tkinter import *
...
filemenu.add_command(label="Ac",command=mOpen)
filemenu.add_command(label="Farkli Kaydet")
#filemenu.add_command(label="Colour", command=mColor)
filemenu.add_command(label="Cikis", command=mQuit)
menubar.add_cascade(label="Dosya",menu=filemenu)


#Edit
editmenu=Menu(menubar,tearoff=0)
editmenu.add_command(label="Dosya Icinde Ara")
editmenu.add_command(label="Url Duzenle")
editmenu.add_command(label="Proxy Duzenle")
editmenu.add_command(label="Yerel Ag Duzenle")
menubar.add_cascade(label="Duzenle",menu=editmenu)


#Tools
insertmenu=Menu(menubar,tearoff=0)
insertmenu.add_command(label="Proxy Sunucu Ekle")
insertmenu.add_command(label="Url Ekle")
insertmenu.add_command(label="Ip ekle")
insertmenu.add_command(label="Ag Ekle")
insertmenu.add_command(label="Yerel Ag Ekle")
menubar.add_cascade(label="Araclar",menu=insertmenu)

#Help menu
helpmenu=Menu(menubar,tearoff=0)
helpmenu.add_command(label="Hakkimizda",command=mAbout)
helpmenu.add_command(label="Nasil Yaparim?")
helpmenu.add_checkbutton(label="Check?")
menubar.add_cascade(label="Yardim",menu=helpmenu)
